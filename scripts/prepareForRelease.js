...
const srcPath = path.join(process.cwd(), "src/GatherMaster.cs");
const distPath = path.join(process.cwd(), "GatherMaster.cs");
...
const header =
  '// This is an auto generated file. Please edit "src/GatherMaster.cs" instead.';
